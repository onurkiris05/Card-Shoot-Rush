...
namespace Game.Managers
{
    public class EndGameManager : MonoBehaviour
    {
        ...
        [SerializeField] private EndGameBarrel endGameBarrelPrefab;
        ...
        private void CreateBarrels()
        {
            ...
            for (int i = 0; i < rowCount; i++)
            {
                ...
                {
                    var barrel = (EndGameBarrel)PrefabUtility.InstantiatePrefab(endGameBarrelPrefab, transform);
        ...
        {
            var endGameBarrels = FindObjectsOfType<EndGameBarrel>().ToList();
